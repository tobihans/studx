...
<template>
  <div class="flex flex-col flex-1 w-full">
    ...
    <Form
      v-if="!isSignupOperation"
      @submit="submit"
      @on-invalid-submit="invalidSubmit"
    ...
    >
      ...
      <div class="px-4 py-3">
        <FormField
          class="my-4"
          name="username"
          placeholder="13368720"
          label="ID"
        />
        <FormField
          v-show="isSignupOperation"
          class="my-4"
          name="email"
          placeholder="kadoukpe-bignon-hans.tognon@etudiant.bj"
          label="Email"
        />
        <FormField
          class="my-4"
